...
namespace TickAndDashReportingTool.Services
{
    public class SMSService: ISMSService
    {
        ...
        public static string ArabicToHex(string s)
        {
        ...
        private void InsertToSender(string msisdn, string msg)
        {
            ...
            using (var sqlConnection = new SqlConnection("Data Source = .;Initial Catalog = DirectBillingDB; User ID = sa; Password=smsit@ut@2012"))
            {
                int affectedRows = sqlConnection.Execute(query, new
                {
                    ...
                    IsHex = 1,
                    Msg = outRespons.MobileNumber.StartsWith("+972") ? ArabicToHex(outRespons.Msg) : outRespons.Msg,
